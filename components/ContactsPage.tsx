...
const STRINGS: Record<
  Locale,
  { heading: string; hiddenTitle: string; telegramCta: string; address: string }
> = {
  uk: {
    heading: 'Контактна інформація',
    hiddenTitle: 'Контакти',
    telegramCta: 'Написати в Telegram',
    address: 'м. Київ, вул. Тираспольська, 54',
  },
  ru: {
    heading: 'Контактная информация',
    hiddenTitle: 'Контакты',
    telegramCta: 'Написать в Telegram',
    address: 'г. Киев, ул. Тираспольская, 54',
  },
}
      ...
      <section className="mx-auto max-w-container px-4 py-16 md:px-16 lg:px-28">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
          <div className="pl-6 md:pl-10 md:pt-10">
            <h2 className="mb-6 text-2xl font-medium">{t.heading}</h2>
            ...
            <address className="mb-8 text-base not-italic leading-6">{t.address}</address>
